#' For reading in matrix files generated by gasp Software
#'
#' @param filename string, name of the file
#' @param sep by default set to nothing, but can also acommodate comma-separated values, or other
#'
#' @return returns the matrix that is read in
#' @export
#'
#' @examples
#' x <- c(1:3)
